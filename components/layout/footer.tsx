...
export function Footer() {
  return (
    <footer className="relative border-t border-white/10 bg-[#08090c] py-14">
      <Container className="grid gap-12 lg:grid-cols-[1.35fr_1fr_1fr_1fr]">
        <div className="max-w-sm">
          ...
          <h3 className="mt-4 font-heading text-2xl tracking-tight text-white">
            Design time with intention.
          </h3>
          <p className="mt-4 text-sm leading-relaxed text-white/64">
            Premium productivity infrastructure for people who want calm,
            structure, and high-leverage execution.
          </p>
          <p className="mt-6 text-sm text-white/60">hello@momentum.system</p>
        </div>

        <div>
          <p className="mb-4 text-xs uppercase tracking-[0.2em] text-white/54">Product</p>
        ...
        <div>
          <p className="mb-4 text-xs uppercase tracking-[0.2em] text-white/54">Company</p>
          <div className="space-y-3">
        ...
        <div>
          <p className="mb-4 text-xs uppercase tracking-[0.2em] text-white/54">Connect</p>
          <div className="space-y-3">
      ...
      <Container className="mt-12 border-t border-white/10 pt-6 text-xs text-white/45">
        Copyright (c) {new Date().getFullYear()} Momentum Systems. All rights reserved.
      </Container>
    </footer>
  );
}
