...
const trustItems = ["Used by 120K+ planners", "4.9/5 product rating", "SOC 2-ready"];
      ...
      <Container className="grid items-center gap-12 lg:grid-cols-[1.06fr_0.94fr] lg:gap-8">
        <Reveal className="max-w-2xl">
          <Badge className="mb-6 border-accent/35 bg-accent/10 text-accent">
            Premium Productivity Infrastructure
          </Badge>
          ...
          <p className="mt-6 max-w-xl text-base leading-relaxed text-white/72 sm:text-lg">
            Momentum transforms chaos into structure. Plan with clarity, execute
            in deep work mode, and review progress like a high-performance
            system.
          </p>
          <div className="mt-9 flex flex-wrap gap-3">
            <Button href="/pricing" size="lg">
              Build Your Day <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
              ...
              <div className="mt-3 grid gap-3 sm:grid-cols-[1.2fr_0.8fr]">
                <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-4">
                  ...
                  <div className="mt-4 space-y-3">
                    {[
                      { label: "Deep Work", width: "74%" },
                      { label: "Decision Calls", width: "35%" },
                      { label: "Recovery", width: "28%" }
                    ].map((item) => (
                      <div key={item.label}>
                ...
                <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.02] p-4">
                  ...
                  <p className="mt-2 font-heading text-2xl text-white">In Control</p>
                  <p className="mt-1 text-sm text-white/62">
                    Structured rhythm active for 14 days straight.
                  </p>
                  <motion.div
